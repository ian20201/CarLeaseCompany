                            ...
                            <div class="display-table">
                                <div class="display-table-cell">
                                    <div class="article-body">
                                        ...
                                        <form class="appointment" action="AppSummary.php" method="post" style="display: none">
                                            <div class="username">
                                            ...
                                            <div>
                                                <textarea placeholder="Purpose" required name="purpose" rows="10"
                                                          style="width: 100%"></textarea>
                                            </div>
                                            <div class="slider">
                                                <p>STAFF: </p>
                                                <select class="user-select" required name="staffInfo">
                                                    <?php foreach ($staffList as $staff): ?>
                                                        <option value="<?= $staff['SID'] ?>"><?= $staff['sfirstname'] ?> <?= $staff['slastname'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                            <div class="slider">
                                                <p>AppType: </p>
                                                <select class="user-select" required name="AppType">
                                                    <option value="Lease">Lease</option>
                                                    <option value="Buy">Buy</option>
                                                </select>
                                            </div>
                                            <div class="log-btn">
                                                <button type="submit" class="readmore-btn" style="background-color: black">Create an Appointment
                                                    <i class="fa fa-long-arrow-right"></i></button>
                                            </div>
                                        </form>
                                        <a href="#" class="readmore-btn" onclick="$('.appointment').show(); $(this).hide();$('.view').hide();$('.reference').hide()">Create an Appointment
                                            <i class="fa fa-long-arrow-right"></i></a>

                                        <form class="view" action="viewAppointment.php" method="post">
                                            <div class="username">
                                                <input type="hidden" name="CID" value="<?=$user['CID']?>">
                                                </br>
                                                <input type="number" placeholder="Appointment Number" required name="AID">
                                            </div>
                                            <div class="log-btn">
                                                <button type="submit" class="readmore-btn" style="background-color: black">View Appointment
                                                    <i class="fa fa-long-arrow-right"></i></button>
                                            </div>
                                        </form>

                                        <form class="reference" action="referenceCID.php" method="post">
                                            <div class="username">
                                                <input type="hidden" name="CID" value="<?=$user['CID']?>">
                                                </br>
                                                <input type="number" placeholder="Customer CID" required name="CID2">
                                            </div>
                                            <div class="log-btn">
                                                <button type="submit" class="readmore-btn" style="background-color: black">Reference Other Customer
                                                    <i class="fa fa-long-arrow-right"></i></button>
                                            </div>
                                        </form>
                                    </div>
