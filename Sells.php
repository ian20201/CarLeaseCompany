                            ...
                            <div class="display-table">
                                <div class="display-table-cell">
                                    <div class="article-body">
                                        ...
                                        <?php if($appType == 'Lease'):?>
                                        </br>
                                        <?= SaveCustomerleasewilling($AID,$conn)?>
                                        <div>
                                            <form class="appointment" action="leaseCar.php" method="post" >
                                                <input type="hidden" name="AID" value="<?=$AID;?>">
                                                <input type="hidden" name="CID" value="<?=$user['CID']?>">
                                                <input type="hidden" name="appType" value="<?=$appType?>">
                                                </br>
                                                <input placeholder="DriverLicence" type="text" required name="Driverlicence">
                                                <div class="log-btn">
                                                <button type="submit" class="readmore-btn" style="background-color: black">Create Driver Licence & Lease Car
                                                    <i class="fa fa-long-arrow-right"></i></button>
                                                </div>
                                            </form>
                                        </div>
                                        <?php elseif ($appType == 'Buy'):?>
                                        </br>
                                        <?= SaveCustomerbuywilling($AID,$conn)?>
                                        <div>
                                            <form class="appointment" action="buyCar.php" method="post" >
                                                <input type="hidden" name="AID" value="<?=$AID;?>">
                                                <input type="hidden" name="appType" value="<?=$appType?>">
                                                <input type="hidden" name="CID" value="<?=$user['CID']?>">
                                                <div class="log-btn">
                                                <button type="submit" class="readmore-btn" style="background-color: black">Buy Car
                                                    <i class="fa fa-long-arrow-right"></i></button>
                                                </div>
                                                </form>
                                        </div>
