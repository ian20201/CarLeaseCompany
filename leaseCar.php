                            ...
                            <div class="display-table">
                                <div class="display-table-cell">
                                    <div class="article-body">
                                        ...
                                        <ul>
                                            <li> Driver Licence Save Status: <?= $realDID['DID']?></li>
                                            </br>
                                        ...
                                        <form class="appointment" action="LeasingBooked.php" method="post" >
                                        <div class="slider">
                                            <input type="hidden" name="AID" value="<?=$AID?>">
                                            <input type="hidden" name="DID" value="<?=$realDID['DID']?>">
                                            <p>Choose Cars: </p>
