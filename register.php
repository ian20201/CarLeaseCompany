                ...
                <div class="col-lg-5 col-md-8 m-auto">
                	<div class="login-page-content">
                		<div class="login-form">
                			<h3>Sign Up</h3>
							<form action="CreatCustomer.php" method="post">
								<div class="name">
									<div class="row">
										<div class="col-md-6">
                		...
                		<div class="create-ac">
                            ...
                            <p>Creat a staff account? <a href="staff_register.php">Sign Up</a></p>
                            <p>Creat a supervisor account? <a href="supervisor_register.php">Sign Up</a></p>
                		</div>
