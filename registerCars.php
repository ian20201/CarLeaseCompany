            ...
            <div class="col-lg-5 col-md-8 m-auto">
                <div class="login-page-content">
                    <div class="login-form">
                        <h3>Register New Car In Stock</h3>
                        <form action="addCar.php" method="post">
                            <div class="name">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" placeholder="Car Name" required name="carname">
                                    </div>
                                </div>
                            </div>
                            <div class="price">
                            ...
                            <div class="slider" >
                                <select class="custom-select" required name="selltype">
                                    <option required value="Lease">Lease</option>
                                    <option required value="Buy">Buy</option>
                                </select>
                            </div>
                            <div class="log-btn">
                    ...
                    <div class="create-ac">
                        <p>Have fun to register new Car</p>
                    </div>
